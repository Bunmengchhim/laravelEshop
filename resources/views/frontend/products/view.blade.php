            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <h2 class="mb-0">
                        ...
                        <label style="font-size:16px" class="float-end badge bg-danger trending_tag">Trendning</label>                          
                        @endif
                    </h2>
                    <hr>
                    ...
                    <div class="row mt-2">
                        <div class="col-md-2">
                            ...
                            <div class="input-group-prepend text-center">
                                <button class="input-group-text w-30 decrement-btn">--</button>
                              ...
                              <div class="input-group-prepend">
                                <button class="input-group-text w-30 increment-btn">+</button>
                              </div>
